...
// Boundy value testing
    ...
    // Boundy value testing
    @Test
    public void testLottoAppChackForMaxPicksFifty() {
        String drawing = "42 26 33 2 45 12";
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testLottoAppChackForMaxPicksFiftyOne() {
        String drawing = "42 26 33 2 45 12";
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testLottoAppDrawingEmpty() {
        String drawing = "";
        String[] picks = new String[51];
        for (int i =0; i<51;i++ ){
            picks[i] = "13 4 36 42 8 12";
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testLottoAppOnePickEmpty() {
        String drawing = "3 11 18 23 37 45";
